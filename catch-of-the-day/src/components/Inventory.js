...
class Inventory extends React.Component{
	...
	authenticate(provider){
		...
		base.createUserWithEmailAndPassword('abc', 'def')
	...
	renderInventory(key){
		...
		return(
			...
			<textarea type="text" name="desc" value={fish.desc} placeholder="Fish desc" value={fish.desc}	
	...
	render(){
		const logout = <button> Logo Out!</button>;
		//check if they are lnot ogged in
 		if(!this.state.uid)
		{
